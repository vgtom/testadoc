...
import TemSubmissionPreview from "../features/documents/templates/containers/TemSubmissionPreview";
...
const SubmissionPreviewPage = () => {
  ...
  return (
    <div>
        <TemSubmissionPreview fileUrl={fileUrl} template={template}/>
    </div>
  );
};

export default withProtectedLayout(SubmissionPreviewPage);
